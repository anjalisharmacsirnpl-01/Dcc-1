...
load_dotenv()
app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv("DATABASE_URL", "postgresql://niharikabhatia@localhost/dcc")
...
def upload_excel():
    ...
    pdf_base_folder_name, pdf_data = pdf_generator.execute_pdf_generator(excel_filepath, doc_type)
